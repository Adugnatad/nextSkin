    ...
    <>
      ...
      <div className="flex flex-col items-center md:mt-[20px] w-full">
        <div className="flex flex-col  items-center my-5">
          <span className="text-[36px] text-center font-bold mb-2 uppercase">
            aftercare products
          </span>
          <img src="/assets/colorfulBorder.svg" />
        </div>
        <div className="flex flex-row overflow-x-auto scrolling-touch tb:scrollbar-hide md:scrollbar-show p-3 w-full tb:w-fit tb:grid tb:grid-cols-3">
