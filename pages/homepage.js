...
const Homepage = () => {
    ...
    const Slide1 = () => {
        return (
            <div className='self-center lg:self-start' >
                <div className='flex flex-col md:items-center lg:items-start self-center text-center lg:text-start lg:self-start mt-3 lg:mt-4 w-full'>
                    <span className='text-white text-[60px] tb:text-[75px] font-bold leading-none'>ALL YOU NEED <br />TO BE EPIC</span>
                    <p className='md:max-w-[70%] lg:max-w-[550px] text-[17px] lg:text-[20px] text-white mt-10 px-4 lg:px-[0px] lg:mt-5'>If your skin has started to show wear and tear from sun, aging, acne or other skin conditions there is much that can be done.</p>
                </div>
            </div>
        )
    }
    ...
    const Slide3 = () => {
        return (
            <div className='self-center md:items-center lg:items-start' >
                <div className='flex flex-col items-center self-center text-center lg:text-start lg:self-start mt-3 lg:mt-4 w-full '>
